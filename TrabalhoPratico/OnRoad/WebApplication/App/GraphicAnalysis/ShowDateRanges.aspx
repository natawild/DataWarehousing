    ...
    <form id="Filter_Tree" name="Filter_Tree" method="post" runat="server">		
			<table align="left" cellSpacing="0" cellPadding="0" border="0" width="100%">
				...
				<tr>
					<td align="center">
						<table><tr><td>
						<% H.WPButton("button","btnFilter",BizAgi.UI.WFBase.CResourceManager.RM.GetString("GA_FilterButton"), BizAgi.UI.WFBase.CResourceManager.RM.GetString("GA_FilterButton"),"sbttn","onclick=\"saveResource(document.Filter_Tree);\""); %>
						</td><td>&nbsp;&nbsp;</td><td>
			...
			<input type="hidden" name="h_Dimension" id="h_Dimension"value="<%= Request.QueryString["h_dimension"] %>">
