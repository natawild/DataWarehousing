...
function ShowStopwatchProperties_Read(oStopwatch){
   ...
   $("#txtStopwatchRead_Name").html(oStopwatch.name);
   $("#txtStopwatchRead_DisplayName").html(oStopwatch.displayName);
...
function ShowCounterProperties_Read(oCounter){
   ...
   $("#txtCounterRead_Name").html(oCounter.name);
   $("#txtCounterRead_DisplayName").html(oCounter.displayName);
